...
/**
 * Simple path configuration for borg-extension
 * Standard paths based on Claude Code conventions
 */

// Base directories
export const DATA_DIR = SettingsDefaultsManager.get('CLAUDE_MEM_DATA_DIR');
// Note: CLAUDE_CONFIG_DIR is a Claude Code setting, not borg-extension, so leave as env var
...
export const DB_PATH = join(DATA_DIR, 'borg-extension.db');
