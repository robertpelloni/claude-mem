...
export const DEFAULT_CONFIG_PATH = join(homedir(), '.borg-extension', 'transcript-watch.json');
export const DEFAULT_STATE_PATH = join(homedir(), '.borg-extension', 'transcript-watch-state.json');
