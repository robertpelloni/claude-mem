    ...
    <div className="header">
      <h1>
        <div style={{ position: 'relative', display: 'inline-block' }}>
          <img src="borg-extension-logomark.webp" alt="" className={`logomark ${isProcessing ? 'spinning' : ''}`} />
          {queueDepth > 0 && (
        ...
        <span className="logo-text">borg-extension</span>
      </h1>
      <div className="status">
        <a
          href="https://docs.borg-extension.ai"
          target="_blank"
        ...
        <GitHubStarsButton username="thedotmack" repo="borg-extension" />
        <select
          value={currentFilter}
