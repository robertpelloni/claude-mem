...
transcript_dir = os.path.expanduser('~/.claude/projects/-Users-alexnewman-Scripts-borg-extension/')
...
output_file = os.path.expanduser('~/Scripts/borg-extension/all_xml_fragments_with_timestamps.xml')
