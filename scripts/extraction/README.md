...
**Output:** `~/Scripts/borg-extension/actual_xml_only_with_timestamps.xml`
...
**Output:** `~/Scripts/borg-extension/all_xml_fragments_with_timestamps.xml`
...
Scripts read from: `~/.claude/projects/-Users-alexnewman-Scripts-borg-extension/*.jsonl`
