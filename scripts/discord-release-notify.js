...
async function postToDiscord(webhookUrl, version, notes) {
  ...
  const repoUrl = 'https://github.com/thedotmack/borg-extension';

  const payload = {
    embeds: [
      {
        title: `🚀 borg-extension ${version} released`,
        ...
        fields: [
          ...
          {
            name: '📚 Docs',
            value: '[docs.borg-extension.ai](https://docs.borg-extension.ai)',
            inline: true,
          },
        ],
        footer: {
          text: 'borg-extension • Persistent memory for Claude Code',
        },
