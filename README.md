...
- Claude automatically invokes the mem-search skill and uses MCP tools to search your memory
...
4. **Search Observations** - Full-text search across observations
5. **Search Sessions** - Full-text search across session summaries
6. **Search Prompts** - Search raw user requests
7. **By Concept** - Find by concept tags (discovery, problem-solution, pattern, etc.)
8. **By File** - Find observations referencing specific files
