#!/usr/bin/env node
import ne from"path";import{stdin as M}from"process";import $ from"better-sqlite3";import{join as u,dirname as F,basename as pe}from"path";import{homedir as A}from"os";import{existsSync as ue,mkdirSync as P}from"fs";import{fileURLToPath as B}from"url";function H(){return typeof __dirname<"u"?__dirname:F(B(import.meta.url))}var j=H(),l=process.env.CLAUDE_MEM_DATA_DIR||u(A(),".borg-extension"),R=process.env.CLAUDE_CONFIG_DIR||u(A(),".claude"),me=u(l,"archives"),le=u(l,"logs"),Te=u(l,"trash"),Se=u(l,"backups"),be=u(l,"settings.json"),C=u(l,"borg-extension.db"),ge=u(l,"vector-db"),Re=u(R,"settings.json"),Ne=u(R,"commands"),he=u(R,"CLAUDE.md");function v(i){P(i,{recursive:!0})}function y(){return u(j,"..","..")}var N=(n=>(n[n.DEBUG=0]="DEBUG",n[n.INFO=1]="INFO",n[n.WARN=2]="WARN",n[n.ERROR=3]="ERROR",n[n.SILENT=4]="SILENT",n))(N||{}),h=class{level;useColor;constructor(){let e=process.env.CLAUDE_MEM_LOG_LEVEL?.toUpperCase()||"INFO";this.level=N[e]??1,this.useColor=process.stdout.isTTY??!1}correlationId(e,s){return`obs-${e}-${s}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.level===0?`${e.message}
