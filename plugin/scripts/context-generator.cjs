"use strict";var Pe=Object.create;var V=Object.defineProperty;var Xe=Object.getOwnPropertyDescriptor;var He=Object.getOwnPropertyNames;var je=Object.getPrototypeOf,We=Object.prototype.hasOwnProperty;var Be=(d,e)=>{for(var s in e)V(d,s,{get:e[s],enumerable:!0})},me=(d,e,s,t)=>{if(e&&typeof e=="object"||typeof e=="function")for(let r of He(e))!We.call(d,r)&&r!==s&&V(d,r,{get:()=>e[r],enumerable:!(t=Xe(e,r))||t.enumerable});return d};var te=(d,e,s)=>(s=d!=null?Pe(je(d)):{},me(e||!d||!d.__esModule?V(s,"default",{value:d,enumerable:!0}):s,d)),Ge=d=>me(V({},"__esModule",{value:!0}),d);var ss={};Be(ss,{generateContext:()=>es});module.exports=Ge(ss);var Q=te(require("path"),1),z=require("os"),H=require("fs");var Le=require("bun:sqlite");var N=require("path"),fe=require("os"),Oe=require("fs");var Re=require("url");var X=require("fs"),Se=require("path"),be=require("os");var re=["bugfix","feature","refactor","discovery","decision","change"],ne=["how-it-works","why-it-exists","what-changed","problem-solution","gotcha","pattern","trade-off"],Ee={bugfix:"\u{1F534}",feature:"\u{1F7E3}",refactor:"\u{1F504}",change:"\u2705",discovery:"\u{1F535}",decision:"\u2696\uFE0F","session-request":"\u{1F3AF}"},Te={discovery:"\u{1F50D}",change:"\u{1F6E0}\uFE0F",feature:"\u{1F6E0}\uFE0F",bugfix:"\u{1F6E0}\uFE0F",refactor:"\u{1F6E0}\uFE0F",decision:"\u2696\uFE0F"},ge=re.join(","),he=ne.join(",");var K=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(K||{}),oe=class{level=null;useColor;listeners=[];constructor(){this.useColor=process.stdout.isTTY??!1}addListener(e){this.listeners.push(e)}removeListener(e){this.listeners=this.listeners.filter(s=>s!==e)}getLevel(){if(this.level===null){let e=k.get("CLAUDE_MEM_LOG_LEVEL").toUpperCase();this.level=K[e]??1}return this.level}correlationId(e,s){return`obs-${e}-${s}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let s=Object.keys(e);return s.length===0?"{}":s.length<=3?JSON.stringify(e):`{${s.length} keys: ${s.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,s){if(!s)return e;try{let t=typeof s=="string"?JSON.parse(s):s;if(e==="Bash"&&t.command){let r=t.command.length>50?t.command.substring(0,50)+"...":t.command;return`${e}(${r})`}if(e==="Read"&&t.file_path){let r=t.file_path.split("/").pop()||t.file_path;return`${e}(${r})`}if(e==="Edit"&&t.file_path){let r=t.file_path.split("/").pop()||t.file_path;return`${e}(${r})`}if(e==="Write"&&t.file_path){let r=t.file_path.split("/").pop()||t.file_path;return`${e}(${r})`}return e}catch{return e}}formatTimestamp(e){let s=e.getFullYear(),t=String(e.getMonth()+1).padStart(2,"0"),r=String(e.getDate()).padStart(2,"0"),o=String(e.getHours()).padStart(2,"0"),a=String(e.getMinutes()).padStart(2,"0"),c=String(e.getSeconds()).padStart(2,"0"),p=String(e.getMilliseconds()).padStart(3,"0");return`${s}-${t}-${r} ${o}:${a}:${c}.${p}`}log(e,s,t,r,o){if(e<this.getLevel())return;let a=this.formatTimestamp(new Date),c=K[e].padEnd(5),p=s.padEnd(6),l="";r?.correlationId?l=`[${r.correlationId}] `:r?.sessionId&&(l=`[session-${r.sessionId}] `);let u="";o!=null&&(this.getLevel()===0&&typeof o=="object"?u=`
`+JSON.stringify(o,null,2):u=" "+this.formatData(o));let T="";if(r){let{sessionId:O,sdkSessionId:E,correlationId:n,...f}=r;Object.keys(f).length>0&&(T=` {${Object.entries(f).map(([R,I])=>`${R}=${I}`).join(", ")}}`)}let g=`[${a}] [${c}] [${p}] ${l}${t}${T}${u}`;e===3?console.error(g):console.log(g);let m={timestamp:a,level:K[e],component:s,message:t,context:r,data:o?this.formatData(o):void 0};this.listeners.forEach(O=>{try{O(m)}catch(E){console.error("Error in log listener:",E)}})}debug(e,s,t,r){this.log(0,e,s,t,r)}info(e,s,t,r){this.log(1,e,s,t,r)}warn(e,s,t,r){this.log(2,e,s,t,r)}error(e,s,t,r){this.log(3,e,s,t,r)}dataIn(e,s,t,r){this.info(e,`\u2192 ${s}`,t,r)}dataOut(e,s,t,r){this.info(e,`\u2190 ${s}`,t,r)}success(e,s,t,r){this.info(e,`\u2713 ${s}`,t,r)}failure(e,s,t,r){this.error(e,`\u2717 ${s}`,t,r)}timing(e,s,t,r){this.info(e,`\u23F1 ${s}`,r,{duration:`${t}ms`})}happyPathError(e,s,t,r,o=""){let l=((new Error().stack||"").split(`
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),u=l?`${l[1].split("/").pop()}:${l[2]}`:"unknown",T={...t,location:u};return this.warn(e,`[HAPPY-PATH] ${s}`,T,r),o}},L=new oe;var k=class{static DEFAULTS={CLAUDE_MEM_MODEL:"claude-sonnet-4-5",CLAUDE_MEM_CONTEXT_OBSERVATIONS:"50",CLAUDE_MEM_WORKER_PORT:"37777",CLAUDE_MEM_WORKER_HOST:"127.0.0.1",CLAUDE_MEM_SKIP_TOOLS:"ListMcpResourcesTool,SlashCommand,Skill,TodoWrite,AskUserQuestion",CLAUDE_MEM_DATA_DIR:(0,Se.join)((0,be.homedir)(),".claude-mem"),CLAUDE_MEM_LOG_LEVEL:"INFO",CLAUDE_MEM_PYTHON_VERSION:"3.13",CLAUDE_CODE_PATH:"",CLAUDE_MEM_CONTEXT_SHOW_READ_TOKENS:"true",CLAUDE_MEM_CONTEXT_SHOW_WORK_TOKENS:"true",CLAUDE_MEM_CONTEXT_SHOW_SAVINGS_AMOUNT:"true",CLAUDE_MEM_CONTEXT_SHOW_SAVINGS_PERCENT:"true",CLAUDE_MEM_CONTEXT_OBSERVATION_TYPES:ge,CLAUDE_MEM_CONTEXT_OBSERVATION_CONCEPTS:he,CLAUDE_MEM_CONTEXT_FULL_COUNT:"5",CLAUDE_MEM_CONTEXT_FULL_FIELD:"narrative",CLAUDE_MEM_CONTEXT_SESSION_COUNT:"10",CLAUDE_MEM_CONTEXT_SHOW_LAST_SUMMARY:"true",CLAUDE_MEM_CONTEXT_SHOW_LAST_MESSAGE:"false"};static getAllDefaults(){return{...this.DEFAULTS}}static get(e){return this.DEFAULTS[e]}static getInt(e){let s=this.get(e);return parseInt(s,10)}static getBool(e){return this.get(e)==="true"}static loadFromFile(e){if(!(0,X.existsSync)(e))return this.getAllDefaults();let s=(0,X.readFileSync)(e,"utf-8"),t=JSON.parse(s),r=t;if(t.env&&typeof t.env=="object"){r=t.env;try{(0,X.writeFileSync)(e,JSON.stringify(r,null,2),"utf-8"),L.info("SETTINGS","Migrated settings file from nested to flat schema",{settingsPath:e})}catch(a){L.warn("SETTINGS","Failed to auto-migrate settings file",{settingsPath:e},a)}}let o={...this.DEFAULTS};for(let a of Object.keys(this.DEFAULTS))r[a]!==void 0&&(o[a]=r[a]);return o}};var Ve={};function Ye(){return typeof __dirname<"u"?__dirname:(0,N.dirname)((0,Re.fileURLToPath)(Ve.url))}var ms=Ye(),y=k.get("CLAUDE_MEM_DATA_DIR"),ie=process.env.CLAUDE_CONFIG_DIR||(0,N.join)((0,fe.homedir)(),".claude"),Es=(0,N.join)(y,"archives"),Ts=(0,N.join)(y,"logs"),gs=(0,N.join)(y,"trash"),hs=(0,N.join)(y,"backups"),Ss=(0,N.join)(y,"settings.json"),Ne=(0,N.join)(y,"claude-mem.db"),bs=(0,N.join)(y,"vector-db"),fs=(0,N.join)(ie,"settings.json"),Os=(0,N.join)(ie,"commands"),Rs=(0,N.join)(ie,"CLAUDE.md");function Ae(d){(0,Oe.mkdirSync)(d,{recursive:!0})}var q=class{db;constructor(){Ae(y),this.db=new Le.Database(Ne),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable()}runMigration(e,s,t){try{if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(e))return;console.log(`[SessionStore] Applying migration ${e}: ${s}...`),this.db.transaction(()=>{t(),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(e,new Date().toISOString())})(),console.log(`[SessionStore] Migration ${e} (${s}) applied successfully`)}catch(r){throw console.error(`[SessionStore] Migration ${e} (${s}) failed:`,r.message),r}}initializeSchema(){try{this.db.run(`
    ...
    `).get(e)||null}getFilesForSession(e){let t=this.db.prepare(`
      ...
      FROM observations
      WHERE sdk_session_id = ?
    `).all(e),r=new Set,o=new Set;for(let a of t){if(a.files_read)try{let c=JSON.parse(a.files_read);Array.isArray(c)&&c.forEach(p=>r.add(p))}catch{}if(a.files_modified)try{let c=JSON.parse(a.files_modified);Array.isArray(c)&&c.forEach(p=>o.add(p))}catch{}}return{filesRead:Array.from(r),filesModified:Array.from(o)}}getSessionById(e){return this.db.prepare(`
    ...
    `).run(e,s,t,r.toISOString(),o).lastInsertRowid}getUserPrompt(e,s){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,s)?.prompt_text??null}storeObservation(e,s,t,r,o=0){let a=new Date,c=a.getTime();this.db.prepare(`
    ...
    `).get(e)||(this.db.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,s,t.type,t.title,t.subtitle,JSON.stringify(t.facts),t.narrative,JSON.stringify(t.concepts),JSON.stringify(t.files_read),JSON.stringify(t.files_modified),r||null,o,a.toISOString(),c);return{id:Number(T.lastInsertRowid),createdAtEpoch:c}}storeSummary(e,s,t,r,o=0){let a=new Date,c=a.getTime();this.db.prepare(`
      SELECT id FROM sdk_sessions WHERE sdk_session_id = ?
    `).get(e)||(this.db.prepare(`
        INSERT INTO sdk_sessions
        (claude_session_id, sdk_session_id, project, started_at, started_at_epoch, status)
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,s,t.request,t.investigated,t.learned,t.completed,t.next_steps,t.notes,r||null,o,a.toISOString(),c);return{id:Number(T.lastInsertRowid),createdAtEpoch:c}}markSessionCompleted(e){let s=new Date,t=s.getTime();this.db.prepare(`
      UPDATE sdk_sessions
    ...
    `).run(s.toISOString(),t,e)}markSessionFailed(e){let s=new Date,t=s.getTime();this.db.prepare(`
      ...
      WHERE id = ?
    `).run(s.toISOString(),t,e)}getSessionSummariesByIds(e,s={}){if(e.length===0)return[];let{orderBy:t="date_desc",limit:r,project:o}=s,a=t==="date_asc"?"ASC":"DESC",c=r?`LIMIT ${r}`:"",p=e.map(()=>"?").join(","),l=[...e],u=o?`WHERE id IN (${p}) AND project = ?`:`WHERE id IN (${p})`;return o&&l.push(o),this.db.prepare(`
      SELECT * FROM session_summaries
      ${u}
      ORDER BY created_at_epoch ${a}
      ${c}
    `).all(...l)}getUserPromptsByIds(e,s={}){if(e.length===0)return[];let{orderBy:t="date_desc",limit:r,project:o}=s,a=t==="date_asc"?"ASC":"DESC",c=r?`LIMIT ${r}`:"",p=e.map(()=>"?").join(","),l=[...e],u=o?"AND s.project = ?":"";return o&&l.push(o),this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.sdk_session_id
      ...
      ${c}
    `).all(...l)}getTimelineAroundTimestamp(e,s=10,t=10,r){return this.getTimelineAroundObservation(null,e,s,t,r)}getTimelineAroundObservation(e,s,t=10,r=10,o){let a=o?"AND project = ?":"",c=o?[o]:[],p,l;if(e!==null){let m=`
      ...
      `,O=`
        ...
        ORDER BY created_at_epoch ASC
        LIMIT ?
      `;try{let E=this.db.prepare(m).all(s,...c,t),n=this.db.prepare(O).all(s,...c,r+1);if(E.length===0&&n.length===0)return{observations:[],sessions:[],prompts:[]};p=E.length>0?E[E.length-1].created_at_epoch:s,l=n.length>0?n[n.length-1].created_at_epoch:s}catch(E){return console.error("[SessionStore] Error getting boundary timestamps:",E.message,o?`(project: ${o})`:"(all projects)"),{observations:[],sessions:[],prompts:[]}}}let u=`
      SELECT *
      FROM observations
    ...
    `).get(e)||null}getEndlessModeStats(){try{let e=this.db.prepare("SELECT SUM(discovery_tokens) as tokens, COUNT(*) as count FROM observations").get(),s=this.db.prepare("SELECT SUM(discovery_tokens) as tokens FROM session_summaries").get(),t=this.db.prepare("SELECT COUNT(*) as count FROM sdk_sessions").get(),r=this.db.prepare(`
      ...
      `).get(),o=this.db.prepare(`
        ...
        FROM session_summaries
        WHERE discovery_tokens = 0
      `).get(),a=Math.floor(((r?.estimated_chars||0)+(o?.estimated_chars||0))/4);return{totalArchivedTokens:(e?.tokens||0)+(s?.tokens||0)+a,totalSessions:t?.count||0,totalObservations:e?.count||0}}catch(e){return console.error("[SessionStore] Failed to get endless mode stats:",e),{totalArchivedTokens:0,totalSessions:0,totalObservations:0}}}getKnowledgeGraph(e=50){let s=new Map,t=new Set;try{let r=this.db.prepare(`
        SELECT id, sdk_session_id, project, started_at_epoch
        FROM sdk_sessions
        WHERE status != 'failed'
        ORDER BY started_at_epoch DESC
        LIMIT ?
      `).all(e);for(let o of r){let a=`session-${o.id}`;s.set(a,{id:a,label:`Session ${o.id}`,type:"session",val:8,data:o});let c=this.db.prepare(`
          SELECT concepts
          FROM observations
          WHERE sdk_session_id = ?
        `).all(o.sdk_session_id);for(let l of c)if(l.concepts)try{let u=JSON.parse(l.concepts);if(Array.isArray(u))for(let T of u){let g=`concept-${T}`;s.has(g)||s.set(g,{id:g,label:T,type:"concept",val:5});let m=`${a}->${g}`;t.has(m)||t.add(JSON.stringify({source:a,target:g,type:"HAS_CONCEPT"}))}}catch{}let p=this.db.prepare(`
          SELECT files_read, files_modified
          FROM observations
          WHERE sdk_session_id = ?
        `).all(o.sdk_session_id);for(let l of p){let u=(T,g)=>{if(T)try{let m=JSON.parse(T);if(Array.isArray(m))for(let O of m){let E=`file-${O}`,n=O.split("/").pop()||O;if(!s.has(E))s.set(E,{id:E,label:n,type:"file",val:g==="MODIFIED"?6:3,path:O});else if(g==="MODIFIED"){let f=s.get(E);f.val=Math.max(f.val,6)}t.add(JSON.stringify({source:a,target:E,type:g}))}}catch{}};u(l.files_read,"READ"),u(l.files_modified,"MODIFIED")}}return{nodes:Array.from(s.values()),edges:Array.from(t).map(o=>JSON.parse(o))}}catch(r){return console.error("[SessionStore] Failed to get knowledge graph:",r),{nodes:[],edges:[]}}}close(){this.db.close()}importSdkSession(e){let s=this.db.prepare("SELECT id FROM sdk_sessions WHERE claude_session_id = ?").get(e.claude_session_id);return s?{imported:!1,id:s.id}:{imported:!0,id:this.db.prepare(`
      INSERT INTO sdk_sessions (
    ...
    `).run(e.claude_session_id,e.prompt_number,e.prompt_text,e.created_at,e.created_at_epoch).lastInsertRowid}}};var ae=te(require("path"),1);function de(d){if(!d)return[];try{let e=JSON.parse(d);return Array.isArray(e)?e:[]}catch{return[]}}function Ie(d){return new Date(d).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function Ce(d){return new Date(d).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function ve(d){return new Date(d).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function Ke(d,e){return ae.default.isAbsolute(d)?ae.default.relative(e,d):d}function ye(d,e){let s=de(d);return s.length>0?Ke(s[0],e):"General"}var De=te(require("path"),1);function Me(d){if(!d||d.trim()==="")return L.warn("PROJECT_NAME","Empty cwd provided, using fallback",{cwd:d}),"unknown-project";let e=De.default.basename(d);if(e==="")if(process.platform==="win32"&&d.match(/^[A-Z]:\\/i)){let r=`drive-${d[0].toUpperCase()}`;return L.info("PROJECT_NAME","Drive root detected",{cwd:d,projectName:r}),r}else return L.warn("PROJECT_NAME","Root directory detected, using fallback",{cwd:d}),"unknown-project";return e}var qe=Q.default.join((0,z.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function Je(){let d=Q.default.join((0,z.homedir)(),".claude-mem","settings.json"),e=k.loadFromFile(d);try{return{totalObservationCount:parseInt(e.CLAUDE_MEM_CONTEXT_OBSERVATIONS,10),fullObservationCount:parseInt(e.CLAUDE_MEM_CONTEXT_FULL_COUNT,10),sessionCount:parseInt(e.CLAUDE_MEM_CONTEXT_SESSION_COUNT,10),showReadTokens:e.CLAUDE_MEM_CONTEXT_SHOW_READ_TOKENS==="true",showWorkTokens:e.CLAUDE_MEM_CONTEXT_SHOW_WORK_TOKENS==="true",showSavingsAmount:e.CLAUDE_MEM_CONTEXT_SHOW_SAVINGS_AMOUNT==="true",showSavingsPercent:e.CLAUDE_MEM_CONTEXT_SHOW_SAVINGS_PERCENT==="true",observationTypes:new Set(e.CLAUDE_MEM_CONTEXT_OBSERVATION_TYPES.split(",").map(s=>s.trim()).filter(Boolean)),observationConcepts:new Set(e.CLAUDE_MEM_CONTEXT_OBSERVATION_CONCEPTS.split(",").map(s=>s.trim()).filter(Boolean)),fullObservationField:e.CLAUDE_MEM_CONTEXT_FULL_FIELD,showLastSummary:e.CLAUDE_MEM_CONTEXT_SHOW_LAST_SUMMARY==="true",showLastMessage:e.CLAUDE_MEM_CONTEXT_SHOW_LAST_MESSAGE==="true"}}catch(s){return L.warn("WORKER","Failed to load context settings, using defaults",{},s),{totalObservationCount:50,fullObservationCount:5,sessionCount:10,showReadTokens:!0,showWorkTokens:!0,showSavingsAmount:!0,showSavingsPercent:!0,observationTypes:new Set(re),observationConcepts:new Set(ne),fullObservationField:"narrative",showLastSummary:!0,showLastMessage:!1}}}var ke=4,Qe=1,i={reset:"\x1B[0m",bright:"\x1B[1m",dim:"\x1B[2m",cyan:"\x1B[36m",green:"\x1B[32m",yellow:"\x1B[33m",blue:"\x1B[34m",magenta:"\x1B[35m",gray:"\x1B[90m",red:"\x1B[31m"};function J(d,e,s,t){return e?t?[`${s}${d}:${i.reset} ${e}`,""]:[`**${d}**: ${e}`,""]:[]}function ze(d){return d.replace(/\//g,"-")}function Ze(d){try{if(!(0,H.existsSync)(d))return{userMessage:"",assistantMessage:""};let e=(0,H.readFileSync)(d,"utf-8").trim();if(!e)return{userMessage:"",assistantMessage:""};let s=e.split(`
`).filter(r=>r.trim()),t="";for(let r=s.length-1;r>=0;r--)try{let o=s[r];if(!o.includes('"type":"assistant"'))continue;let a=JSON.parse(o);if(a.type==="assistant"&&a.message?.content&&Array.isArray(a.message.content)){let c="";for(let p of a.message.content)p.type==="text"&&(c+=p.text);if(c=c.replace(/<system-reminder>[\s\S]*?<\/system-reminder>/g,"").trim(),c){t=c;break}}}catch{continue}return{userMessage:"",assistantMessage:t}}catch(e){return L.failure("WORKER","Failed to extract prior messages from transcript",{transcriptPath:d},e),{userMessage:"",assistantMessage:""}}}async function es(d,e=!1){let s=Je(),t=d?.cwd??process.cwd(),r=Me(t),o=null;try{o=new q}catch(f){if(f.code==="ERR_DLOPEN_FAILED"){try{(0,H.unlinkSync)(qe)}catch{}return console.error("Native module rebuild needed - restart Claude Code to auto-fix"),""}throw f}let a=Array.from(s.observationTypes),c=a.map(()=>"?").join(","),p=Array.from(s.observationConcepts),l=p.map(()=>"?").join(","),u=o.db.prepare(`
    SELECT
  ...
  `).all(r,...a,...p,s.totalObservationCount),T=o.db.prepare(`
    ...
    ORDER BY created_at_epoch DESC
    LIMIT ?
  `).all(r,s.sessionCount+Qe),g="",m="";if(s.showLastMessage&&u.length>0)try{let f=d?.session_id,A=u.find(R=>R.sdk_session_id!==f);if(A){let R=A.sdk_session_id,I=ze(t),w=Q.default.join((0,z.homedir)(),".claude","projects",I,`${R}.jsonl`),j=Ze(w);g=j.userMessage,m=j.assistantMessage}}catch{}if(u.length===0&&T.length===0)return o?.close(),e?`
...
No previous sessions found for this project yet.`;let O=T.slice(0,s.sessionCount),E=u,n=[];if(e?(n.push(""),n.push(`${i.bright}${i.cyan}[${r}] recent context${i.reset}`),n.push(`${i.gray}${"\u2500".repeat(60)}${i.reset}`),n.push("")):(n.push(`# [${r}] recent context`),n.push("")),E.length>0){e?n.push(`${i.dim}Legend: \u{1F3AF} session-request | \u{1F534} bugfix | \u{1F7E3} feature | \u{1F504} refactor | \u2705 change | \u{1F535} discovery | \u2696\uFE0F  decision${i.reset}`):n.push("**Legend:** \u{1F3AF} session-request | \u{1F534} bugfix | \u{1F7E3} feature | \u{1F504} refactor | \u2705 change | \u{1F535} discovery | \u2696\uFE0F  decision"),n.push(""),e?(n.push(`${i.bright}\u{1F4A1} Column Key${i.reset}`),n.push(`${i.dim}  Read: Tokens to read this observation (cost to learn it now)${i.reset}`),n.push(`${i.dim}  Work: Tokens spent on work that produced this record (\u{1F50D} research, \u{1F6E0}\uFE0F building, \u2696\uFE0F  deciding)${i.reset}`)):(n.push("\u{1F4A1} **Column Key**:"),n.push("- **Read**: Tokens to read this observation (cost to learn it now)"),n.push("- **Work**: Tokens spent on work that produced this record (\u{1F50D} research, \u{1F6E0}\uFE0F building, \u2696\uFE0F  deciding)")),n.push(""),e?(n.push(`${i.dim}\u{1F4A1} Context Index: This semantic index (titles, types, files, tokens) is usually sufficient to understand past work.${i.reset}`),n.push(""),n.push(`${i.dim}When you need implementation details, rationale, or debugging context:${i.reset}`),n.push(`${i.dim}  - Use the mem-search skill to fetch full observations on-demand${i.reset}`),n.push(`${i.dim}  - Critical types (\u{1F534} bugfix, \u2696\uFE0F decision) often need detailed fetching${i.reset}`),n.push(`${i.dim}  - Trust this index over re-reading code for past decisions and learnings${i.reset}`)):(n.push("\u{1F4A1} **Context Index:** This semantic index (titles, types, files, tokens) is usually sufficient to understand past work."),n.push(""),n.push("When you need implementation details, rationale, or debugging context:"),n.push("- Use the mem-search skill to fetch full observations on-demand"),n.push("- Critical types (\u{1F534} bugfix, \u2696\uFE0F decision) often need detailed fetching"),n.push("- Trust this index over re-reading code for past decisions and learnings")),n.push("");let f=u.length,A=u.reduce((_,S)=>{let b=(S.title?.length||0)+(S.subtitle?.length||0)+(S.narrative?.length||0)+JSON.stringify(S.facts||[]).length;return _+Math.ceil(b/ke)},0),R=u.reduce((_,S)=>_+(S.discovery_tokens||0),0),I=R-A,w=R>0?Math.round(I/R*100):0,j=s.showReadTokens||s.showWorkTokens||s.showSavingsAmount||s.showSavingsPercent;if(j)if(e){if(n.push(`${i.bright}${i.cyan}\u{1F4CA} Context Economics${i.reset}`),n.push(`${i.dim}  Loading: ${f} observations (${A.toLocaleString()} tokens to read)${i.reset}`),n.push(`${i.dim}  Work investment: ${R.toLocaleString()} tokens spent on research, building, and decisions${i.reset}`),R>0&&(s.showSavingsAmount||s.showSavingsPercent)){let _="  Your savings: ";s.showSavingsAmount&&s.showSavingsPercent?_+=`${I.toLocaleString()} tokens (${w}% reduction from reuse)`:s.showSavingsAmount?_+=`${I.toLocaleString()} tokens`:_+=`${w}% reduction from reuse`,n.push(`${i.green}${_}${i.reset}`)}n.push("")}else{if(n.push("\u{1F4CA} **Context Economics**:"),n.push(`- Loading: ${f} observations (${A.toLocaleString()} tokens to read)`),n.push(`- Work investment: ${R.toLocaleString()} tokens spent on research, building, and decisions`),R>0&&(s.showSavingsAmount||s.showSavingsPercent)){let _="- Your savings: ";s.showSavingsAmount&&s.showSavingsPercent?_+=`${I.toLocaleString()} tokens (${w}% reduction from reuse)`:s.showSavingsAmount?_+=`${I.toLocaleString()} tokens`:_+=`${w}% reduction from reuse`,n.push(_)}n.push("")}let $e=T[0]?.id,Ue=O.map((_,S)=>{let b=S===0?null:T[S+1];return{..._,displayEpoch:b?b.created_at_epoch:_.created_at_epoch,displayTime:b?b.created_at:_.created_at,shouldShowLink:_.id!==$e}}),xe=new Set(u.slice(0,s.fullObservationCount).map(_=>_.id)),ce=[...E.map(_=>({type:"observation",data:_})),...Ue.map(_=>({type:"summary",data:_}))];ce.sort((_,S)=>{let b=_.type==="observation"?_.data.created_at_epoch:_.data.displayEpoch,D=S.type==="observation"?S.data.created_at_epoch:S.data.displayEpoch;return b-D});let W=new Map;for(let _ of ce){let S=_.type==="observation"?_.data.created_at:_.data.displayTime,b=ve(S);W.has(b)||W.set(b,[]),W.get(b).push(_)}let we=Array.from(W.entries()).sort((_,S)=>{let b=new Date(_[0]).getTime(),D=new Date(S[0]).getTime();return b-D});for(let[_,S]of we){e?(n.push(`${i.bright}${i.cyan}${_}${i.reset}`),n.push("")):(n.push(`### ${_}`),n.push(""));let b=null,D="",$=!1;for(let Z of S)if(Z.type==="summary"){$&&(n.push(""),$=!1,b=null,D="");let h=Z.data,U=`${h.request||"Session started"} (${Ie(h.displayTime)})`;e?n.push(`\u{1F3AF} ${i.yellow}#S${h.id}${i.reset} ${U}`):n.push(`**\u{1F3AF} #S${h.id}** ${U}`),n.push("")}else{let h=Z.data,U=ye(h.files_modified,t);U!==b&&($&&n.push(""),e?n.push(`${i.dim}${U}${i.reset}`):n.push(`**${U}**`),e||(n.push("| ID | Time | T | Title | Read | Work |"),n.push("|----|------|---|-------|------|------|")),b=U,$=!0,D="");let x=Ce(h.created_at),B=h.title||"Untitled",G=Ee[h.type]||"\u2022",Fe=(h.title?.length||0)+(h.subtitle?.length||0)+(h.narrative?.length||0)+JSON.stringify(h.facts||[]).length,F=Math.ceil(Fe/ke),P=h.discovery_tokens||0,ee=Te[h.type]||"\u{1F50D}",_e=P>0?`${ee} ${P.toLocaleString()}`:"-",se=x!==D,le=se?x:"";if(D=x,xe.has(h.id)){let M=s.fullObservationField==="narrative"?h.narrative:h.facts?de(h.facts).join(`
`):null;if(e){let v=se?`${i.dim}${x}${i.reset}`:" ".repeat(x.length),Y=s.showReadTokens&&F>0?`${i.dim}(~${F}t)${i.reset}`:"",ue=s.showWorkTokens&&P>0?`${i.dim}(${ee} ${P.toLocaleString()}t)${i.reset}`:"";n.push(`  ${i.dim}#${h.id}${i.reset}  ${v}  ${G}  ${i.bright}${B}${i.reset}`),M&&n.push(`    ${i.dim}${M}${i.reset}`),(Y||ue)&&n.push(`    ${Y} ${ue}`),n.push("")}else{$&&(n.push(""),$=!1),n.push(`**#${h.id}** ${le||"\u2033"} ${G} **${B}**`),M&&(n.push(""),n.push(M),n.push(""));let v=[];s.showReadTokens&&v.push(`Read: ~${F}`),s.showWorkTokens&&v.push(`Work: ${_e}`),v.length>0&&n.push(v.join(", ")),n.push(""),b=null}}else if(e){let M=se?`${i.dim}${x}${i.reset}`:" ".repeat(x.length),v=s.showReadTokens&&F>0?`${i.dim}(~${F}t)${i.reset}`:"",Y=s.showWorkTokens&&P>0?`${i.dim}(${ee} ${P.toLocaleString()}t)${i.reset}`:"";n.push(`  ${i.dim}#${h.id}${i.reset}  ${M}  ${G}  ${B} ${v} ${Y}`)}else{let M=s.showReadTokens?`~${F}`:"",v=s.showWorkTokens?_e:"";n.push(`| #${h.id} | ${le||"\u2033"} | ${G} | ${B} | ${M} | ${v} |`)}}$&&n.push("")}let C=T[0],pe=u[0];if(s.showLastSummary&&C&&(C.investigated||C.learned||C.completed||C.next_steps)&&(!pe||C.created_at_epoch>pe.created_at_epoch)&&(n.push(...J("Investigated",C.investigated,i.blue,e)),n.push(...J("Learned",C.learned,i.yellow,e)),n.push(...J("Completed",C.completed,i.green,e)),n.push(...J("Next Steps",C.next_steps,i.magenta,e))),m&&(n.push(""),n.push("---"),n.push(""),e?(n.push(`${i.bright}${i.magenta}\u{1F4CB} Previously${i.reset}`),n.push(""),n.push(`${i.dim}A: ${m}${i.reset}`)):(n.push("**\u{1F4CB} Previously**"),n.push(""),n.push(`A: ${m}`)),n.push("")),j&&R>0&&I>0){let _=Math.round(R/1e3);n.push(""),e?n.push(`${i.dim}\u{1F4B0} Access ${_}k tokens of past research & decisions for just ${A.toLocaleString()}t. Use the mem-search skill to access memories by ID instead of re-reading files.${i.reset}`):n.push(`\u{1F4B0} Access ${_}k tokens of past research & decisions for just ${A.toLocaleString()}t. Use the mem-search skill to access memories by ID instead of re-reading files.`)}}return o?.close(),n.join(`
